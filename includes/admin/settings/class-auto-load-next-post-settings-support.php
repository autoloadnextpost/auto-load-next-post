...
class Auto_Load_Next_Post_Settings_Support_Tab extends Auto_Load_Next_Post_Settings_Page {
	...
	public function callback() {
		return '<p>'.__( 'As this is a free plugin, I can not provide support.', 'auto-load-next-post' ).'</p>'.
				'<p>'.sprintf( __( 'You may ask the WordPress community for help by posting to the <a href="%s">WordPress.org support forum</a>. Response time can range from a few days to a few weeks and will likely be from a non-developer.', 'auto-load-next-post' ), 'https://wordpress.org/support/plugin/auto-load-next-post' ).'</p>'.
				'<p>'.sprintf( __( 'If you want a <strong>timely response via email from me</strong>, <a href="%s">upgrade</a> and then send me an email.', 'auto-load-next-post' ), 'https://www.sebastiendumont.com/plugins/auto-load-next-post/?utm_source=insideplugin&utm_medium=web&utm_content=support-tab&utm_campaign=freeplugin-alnp' ).'</p>'.
				'<p>'.sprintf( __( 'If you\'ve found a bug, please <a href="%s">submit an issue on GitHub</a>.', 'auto-load-next-post' ), 'https://github.com/seb86/Auto-Load-Next-Post/issues' ).'</p>'.
