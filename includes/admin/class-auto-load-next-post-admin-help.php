	...
	public function add_help_tabs() {
		...
		$screen->add_help_tab( array(
			...
			'content' =>
				...
				'<p><a href="https://github.com/seb86/Auto-Load-Next-Post/wiki/" class="button button-primary">'.sprintf( __( '%s Documentation', 'auto-load-next-post' ), 'Auto Load Next Post' ).'</a></p>'
		) );
		...
		$screen->add_help_tab( array(
			...
			'content' =>
				...
				'<p><a href="https://github.com/seb86/Auto-Load-Next-Post/issues?state=open" class="button button-primary">'.__( 'Report a bug', 'auto-load-next-post' ).'</a></p>'
		) );
